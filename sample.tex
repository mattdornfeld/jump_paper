...
The name of this file is introrev.tex.
...
tables, etc. More information can be found in Refs.~\onlinecite{latex, website}.
...
\begin{itemize}
\setlength{\itemsep}{-5pt}       % made items closer together
...
As soon as many users start becoming comfortable using \LaTeX, they want
to use some of its advanced features. So we will show you how to place two
figures side by side.

\begin{figure}[h!]
\centering
\subfigure[\ Real and imaginary.]{
\includegraphics[scale=0.5]{reim}}
...
We first have to include the package,
